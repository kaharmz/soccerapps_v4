...
import com.example.soccerapps.view.fragment.favorite.TeamFavoriteFragment
...
class FavoriteFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        actionBar?.title = resources.getString(R.string.favorite_text)
    ...
    private fun setViewPager(viewpagerFavorite: ViewPager?) {
        ...
        val teamFavorite = TeamFavoriteFragment.teamFavoriteInstance()
        adapter?.addFragment(teamFavorite, getString(R.string.team_text))
